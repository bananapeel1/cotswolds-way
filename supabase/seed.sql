...
('the-lygon-arms', 'The Lygon Arms', 'A historic 16th-century coaching inn in the heart of Broadway. The Lygon Arms has hosted Charles I and Oliver Cromwell, and today offers luxury accommodation with all modern amenities for Cotswold Way walkers.', 'Historic coaching inn with luxury rooms', 'inn', 'Broadway', 'WR12 7DU', ST_MakePoint(-1.8563, 52.0356)::geography, 0.1, true, 'Chipping Campden to Broadway', 2, 24500, 4.9, 128, true, true, true, true, true, true, false, true, true, 'The Lygon Arms Team', 'Family-run since the 16th century', NULL),

('holly-house-bnb', 'Holly House B&B', 'A warm and welcoming B&B just steps from the Cotswold Way in Chipping Campden. Perfect for the first or last night of your walk, with hearty breakfasts and a cozy drying room.', 'Cozy walker-friendly B&B at the trail start', 'bnb', 'Chipping Campden', 'GL55 6HB', ST_MakePoint(-1.7798, 52.0536)::geography, 0.1, true, 'Start of Trail', 1, 11500, 4.7, 89, true, true, false, true, false, true, false, true, true, 'Margaret & Peter', '3rd generation Campden residents', NULL),

('the-mount-inn', 'The Mount Inn', 'Perched high on the escarpment above Stanton with panoramic views across the Vale of Evesham. A genuine walkers'' pub with excellent real ales and hearty food.', 'Escarpment pub with stunning views', 'inn', 'Stanton', 'WR12 7NE', ST_MakePoint(-1.8267, 52.0178)::geography, 0.2, true, 'Broadway to Winchcombe', 2, 13500, 4.6, 67, true, false, false, true, false, true, false, true, true, 'James', 'Local publican for 15 years', NULL),

('westward-house', 'Westward House', 'Elegant B&B in the picturesque town of Winchcombe, gateway to Sudeley Castle. Ideally positioned at the midpoint of a Cotswold Way day walk with comfortable ensuite rooms.', 'Elegant B&B in historic Winchcombe', 'bnb', 'Winchcombe', 'GL54 5LJ', ST_MakePoint(-1.9660, 51.9539)::geography, 0.3, true, 'Broadway to Winchcombe', 3, 14500, 4.8, 104, true, true, true, true, true, false, true, true, true, 'Edward', '5th generation Cotswolds resident', NULL),

('cleeve-hill-hotel', 'Cleeve Hill Hotel', 'Set at the highest point of the Cotswold Way with breathtaking views over Cheltenham Racecourse and the Malvern Hills. Spacious rooms and a renowned restaurant.', 'Hilltop hotel at the trail''s highest point', 'hotel', 'Cleeve Hill', 'GL52 3PR', ST_MakePoint(-2.0047, 51.9374)::geography, 0.1, true, 'Winchcombe to Cleeve Hill', 3, 18500, 4.5, 92, true, true, true, false, true, false, false, true, true, 'Cleeve Hill Hotel', 'Family-owned country hotel', NULL),

('the-royal-oak-painswick', 'The Royal Oak', 'A stylish gastro-pub in the "Queen of the Cotswolds" - Painswick. Beautifully restored rooms above a buzzing bar, with locally-sourced menus and craft ales.', 'Stylish gastro-pub in the Queen of the Cotswolds', 'inn', 'Painswick', 'GL6 6QG', ST_MakePoint(-2.1942, 51.7874)::geography, 0.1, true, 'Birdlip to Painswick', 5, 16500, 4.8, 156, true, true, true, true, true, true, true, true, false, 'Tom & Lucy', 'Award-winning restaurateurs', NULL),

('cardynham-house', 'Cardynham House', 'Grade II listed 15th-century wool merchant''s house with stunning period features. Each room individually designed with luxury linens and modern bathrooms.', 'Medieval wool merchant''s house turned luxury B&B', 'bnb', 'Painswick', 'GL6 6YA', ST_MakePoint(-2.1918, 51.7885)::geography, 0.2, true, 'Birdlip to Painswick', 5, 15500, 4.9, 78, false, true, false, false, false, false, true, true, true, 'Amanda', 'Restoring Cotswold heritage since 2010', NULL),

('bear-of-rodborough', 'The Bear of Rodborough', 'A 17th-century coaching inn dramatically situated on Rodborough Common with far-reaching views. Popular with walkers approaching Stroud along the escarpment.', 'Dramatic hilltop coaching inn', 'inn', 'Rodborough', 'GL5 5DE', ST_MakePoint(-2.2174, 51.7236)::geography, 0.4, true, 'Painswick to King''s Stanley', 5, 17500, 4.4, 113, true, true, true, true, true, true, false, true, true, 'Bear Hotels Group', 'Historic Cotswold inn collection', NULL),

('the-old-fleece', 'The Old Fleece', 'A charming boutique hotel in the market town of Stroud, perfect for walkers exploring the Stroud valleys section of the Cotswold Way.', 'Boutique hotel in vibrant Stroud', 'hotel', 'Stroud', 'GL5 1AP', ST_MakePoint(-2.2133, 51.7452)::geography, 0.5, true, 'Painswick to King''s Stanley', 6, 12500, 4.3, 64, false, true, true, false, true, false, true, true, true, 'Old Fleece Team', 'Reviving Stroud''s finest coaching inn', NULL),

('old-sodbury-dog-inn', 'The Dog Inn', 'A traditional English pub with rooms in the quiet village of Old Sodbury. Well-positioned for the final stretch into Bath with genuine country hospitality.', 'Traditional country pub with rooms', 'inn', 'Old Sodbury', 'BS37 6LZ', ST_MakePoint(-2.3496, 51.5395)::geography, 0.2, true, 'Wotton-under-Edge to Old Sodbury', 6, 10500, 4.5, 45, true, false, false, true, false, true, false, true, true, 'Dave & Sue', 'Your final trail hosts', NULL),

('the-swan-wotton', 'The Swan Hotel', 'An elegant Georgian hotel in the handsome town of Wotton-under-Edge. Beautiful rooms overlooking the valley, with a warm welcome for trail walkers.', 'Georgian elegance at trail''s halfway point', 'hotel', 'Wotton-under-Edge', 'GL12 7BE', ST_MakePoint(-2.3541, 51.6366)::geography, 0.3, true, 'Dursley to Wotton-under-Edge', 6, 14000, 4.6, 87, true, true, true, true, true, false, false, true, true, 'Swan Hotel', 'Wotton''s premier accommodation', NULL),

('cold-ashton-manor', 'Cold Ashton Manor B&B', 'A beautiful manor house B&B in the peaceful village of Cold Ashton, the final overnight stop before Bath. Wake up to views across the valley to your destination.', 'Manor house B&B on the doorstep of Bath', 'bnb', 'Cold Ashton', 'SN14 8LA', ST_MakePoint(-2.3672, 51.4199)::geography, 0.3, true, 'Old Sodbury to Cold Ashton', 7, 13500, 4.7, 52, true, true, false, true, false, false, true, true, true, 'Catherine', 'Welcoming walkers to their final night', NULL);
